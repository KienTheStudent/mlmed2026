...
\section{Discussion}
While Classes 0 and 4 show high F1-scores (0.91 and 0.9 respectively), Classes 1, 2, and 3 deal with very low recall (0.19, 0.34 and 0.29 respectively). This indicates that the model frequently misses specific abnormal heartbeats, a direct result of significant class imbalance within the dataset.
